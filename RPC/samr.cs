...
namespace DavidHound.RPC
{
    ...
    public class samr2 : rpcapi
    {
        ...
        private static byte[] M_ProcFormatStringx86 = new byte[] {
        ...
        private static byte[] M_ProcFormatStringx64 = new byte[] {
        ...
        public samr2()
        {
            ...
            if (IntPtr.Size == 8)
            {
                InitializeStub(interfaceId, M_ProcFormatStringx64, MIDL_TypeFormatStringx64, "\\pipe\\samr");
            }
            else
            {
                InitializeStub(interfaceId, M_ProcFormatStringx86, MIDL_TypeFormatStringx86, "\\pipe\\samr");
            }
            UseNullSession = true;
        }
        ...
        public Int32 SamrLookupDomainInSamServer(IntPtr ServerHandle, string Name, out SecurityIdentifier DomainId)
        {
            ...
            using (var NameString = new DavidHound.NativeMethods.UNICODE_STRING())
            {
                try
                {
