...
namespace DavidHound.RPC
{
    public class OxidBindings : rpcapi
    {
        ...
        public OxidBindings()
        {
            ...
            if (IntPtr.Size == 8)
            {
                InitializeStub(interfaceId, M_ProcFormatStringx64, MIDL_TypeFormatStringx64, null, 0);
            }
            else
            {
                InitializeStub(interfaceId, M_ProcFormatStringx86, MIDL_TypeFormatStringx86, null, 0);
            }
        }
