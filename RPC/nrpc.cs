...
namespace DavidHound.RPC
{
    ...
    public class nrpc3 : rpcapi
    {
        ...
        public nrpc3(bool WillUseNullSession = true)
        {
            ...
            if (IntPtr.Size == 8)
            {
                InitializeStub(interfaceId, M_ProcFormatStringx64, MIDL_TypeFormatStringx64, "\\pipe\\netlogon");
            }
            else
            {
                InitializeStub(interfaceId, M_ProcFormatStringx86, MIDL_TypeFormatStringx86, "\\pipe\\netlogon");
            }
