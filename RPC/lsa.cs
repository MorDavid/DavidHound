...
namespace DavidHound.RPC
{
    ...
    public class lsa : rpcapi
    {
        ...
        public lsa()
        {
            ...
            if (IntPtr.Size == 8)
            {
                InitializeStub(interfaceId, M_ProcFormatStringx64, MIDL_TypeFormatStringx64, "\\pipe\\lsarpc", 0);
            }
            else
            {
                InitializeStub(interfaceId, M_ProcFormatStringx86, MIDL_TypeFormatStringx86, "\\pipe\\lsarpc", 0);
            }
            UseNullSession = true;
        }
